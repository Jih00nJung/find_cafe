			...
			<div class="col-md-10">
				...
				<div class="ask_container mt-5">
					<div class="form-group">
						...
						<input
							type="text" class="form-control" id="inquiryResponseTitle"
							name="inquiry_title" placeholder="문의 답변 제목 출력">
					</div>
					<div class="form-group">
						<label for="inquiryResponseContent">내용</label>
						<textarea class="form-control" id="inquiryResponseContent" rows="5"
							name="inquiry_content" placeholder="문의 답변 내용 출력"></textarea>
					</div>
				</div>
			</div>
		</div>
